...
var G__43514 = cljs.core.first(element_str);
switch (G__43514) {
case "?":
arr.push((1));
...
var G__43516 = cljs.core.next(items);
items = G__43516;
continue;
} else {
return null;
...
var G__43517 = cljs.core.next(items);
items = G__43517;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__43519 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__43519) : is_valid_QMARK_.call(null,G__43519));
})())){
var G__43520 = cljs.core.next(cljs.core.next(items));
items = G__43520;
continue;
} else {
return true;
...
switch (G__43523) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,((function (G__43523){
return (function (p1__43521_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__43521_SHARP_,(2));
});})(G__43523))
))){
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__43522_SHARP_,(1));
});})(G__43523))
))){
