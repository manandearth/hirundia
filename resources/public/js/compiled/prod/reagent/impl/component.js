...
if((i < len)){
var k = (ks[i]);
var G__35793 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__35794 = (i + (1));
m = G__35793;
i = G__35794;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35795 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__35795) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__35795));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35797 = c;
var G__35797__$1 = (((G__35797 == null))?null:G__35797.prototype);
if((G__35797__$1 == null)){
return null;
} else {
return (G__35797__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35799 = c;
var G__35799__$1 = (((G__35799 == null))?null:G__35799.prototype);
if((G__35799__$1 == null)){
return null;
} else {
return (G__35799__$1["render"]);
}
})() == null)))));
});
...
var G__35801 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35801) : reagent.impl.component.as_element.call(null,G__35801));
};
...
while (G__35804__i < G__35804__a.length) {G__35804__a[G__35804__i] = arguments[G__35804__i + 0]; ++G__35804__i;}
  args = new cljs.core.IndexedSeq(G__35804__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__35807 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35808 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35808;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35807;
}});
...
var G__35809 = key;
var G__35809__$1 = (((G__35809 instanceof cljs.core.Keyword))?G__35809.fqn:null);
switch (G__35809__$1) {
...
return ((function (G__35809,G__35809__$1){
...
var c = this;
var G__35814_35816 = (c["cljsRatom"]);
if((G__35814_35816 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35814_35816);
}
...
var renders_35818 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_35819 = cljs.core.first(cljs.core.vals(renders_35818));
if((cljs.core.count(renders_35818) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_35818))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_35819)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_35819], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35817 = name;
switch (G__35817) {
case "":
...
var G__35822 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__35822) : reagent.impl.component.global$module$create_react_class.call(null,G__35822));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__35823 = fiber;
var G__35823__$1 = (((G__35823 == null))?null:(G__35823["type"]));
if((G__35823__$1 == null)){
return null;
} else {
return (G__35823__$1["displayName"]);
}
})();
var parent = (function (){var G__35824 = fiber;
if((G__35824 == null)){
return null;
} else {
return (G__35824["return"]);
}
})();
var path = (function (){var G__35825 = parent;
var G__35825__$1 = (((G__35825 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35825) : reagent.impl.component.fiber_component_path.call(null,G__35825)));
if((G__35825__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35825__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__35827 = c;
if((G__35827 == null)){
return null;
} else {
return (G__35827["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__35828._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__35830 = c;
if((G__35830 == null)){
return null;
} else {
return (G__35830["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__35832 = c;
if((G__35832 == null)){
return null;
} else {
return G__35832._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__35834 = instance;
if((G__35834 == null)){
return null;
} else {
return (G__35834["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__35835 = instance;
if((G__35835 == null)){
return null;
} else {
return G__35835._currentElement;
}
}
})();
var name = (function (){var G__35836 = elem;
var G__35836__$1 = (((G__35836 == null))?null:(G__35836["type"]));
if((G__35836__$1 == null)){
return null;
} else {
return (G__35836__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__35838 = elem;
if((G__35838 == null)){
return null;
} else {
return (G__35838["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__35839._owner;
}
}
})();
var path = (function (){var G__35840 = owner;
var G__35840__$1 = (((G__35840 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35840) : reagent.impl.component.component_path.call(null,G__35840)));
if((G__35840__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35840__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__35841 = c;
var G__35841__$1 = (((G__35841 == null))?null:G__35841.constructor);
if((G__35841__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__35841__$1);
}
}
})();
