...
if((i < len)){
var k = (ks[i]);
var G__35425 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__35426 = (i + (1));
m = G__35425;
i = G__35426;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35427 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__35427) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__35427));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35429 = c;
var G__35429__$1 = (((G__35429 == null))?null:G__35429.prototype);
if((G__35429__$1 == null)){
return null;
} else {
return (G__35429__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35431 = c;
var G__35431__$1 = (((G__35431 == null))?null:G__35431.prototype);
if((G__35431__$1 == null)){
return null;
} else {
return (G__35431__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__35435__delegate = function (args){
var G__35433 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35433) : reagent.impl.component.as_element.call(null,G__35433));
};
...
while (G__35436__i < G__35436__a.length) {G__35436__a[G__35436__i] = arguments[G__35436__i + 0]; ++G__35436__i;}
  args = new cljs.core.IndexedSeq(G__35436__a,0,null);
} 
return G__35435__delegate.call(this,args);};
...
return G__35435__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__35439 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35440 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35440;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35439;
}});
...
return ((function (G__35441,G__35441__$1){
...
var c = this;
var G__35446_35448 = (c["cljsRatom"]);
if((G__35446_35448 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35446_35448);
}
...
var renders_35450 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_35451 = cljs.core.first(cljs.core.vals(renders_35450));
if((cljs.core.count(renders_35450) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_35450))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_35451)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_35451], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35449 = name;
switch (G__35449) {
case "":
...
var G__35454 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__35454) : reagent.impl.component.global$module$create_react_class.call(null,G__35454));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__35455 = fiber;
var G__35455__$1 = (((G__35455 == null))?null:(G__35455["type"]));
if((G__35455__$1 == null)){
return null;
} else {
return (G__35455__$1["displayName"]);
}
})();
var parent = (function (){var G__35456 = fiber;
if((G__35456 == null)){
return null;
} else {
return (G__35456["return"]);
}
})();
var path = (function (){var G__35457 = parent;
var G__35457__$1 = (((G__35457 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35457) : reagent.impl.component.fiber_component_path.call(null,G__35457)));
if((G__35457__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35457__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__35459 = c;
if((G__35459 == null)){
return null;
} else {
return (G__35459["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__35460._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__35462 = c;
if((G__35462 == null)){
return null;
} else {
return (G__35462["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__35464 = c;
if((G__35464 == null)){
return null;
} else {
return G__35464._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__35466 = instance;
if((G__35466 == null)){
return null;
} else {
return (G__35466["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__35467 = instance;
if((G__35467 == null)){
return null;
} else {
return G__35467._currentElement;
}
}
})();
var name = (function (){var G__35468 = elem;
var G__35468__$1 = (((G__35468 == null))?null:(G__35468["type"]));
if((G__35468__$1 == null)){
return null;
} else {
return (G__35468__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__35470 = elem;
if((G__35470 == null)){
return null;
} else {
return (G__35470["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__35471._owner;
}
}
})();
var path = (function (){var G__35472 = owner;
var G__35472__$1 = (((G__35472 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35472) : reagent.impl.component.component_path.call(null,G__35472)));
if((G__35472__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35472__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__35473 = c;
var G__35473__$1 = (((G__35473 == null))?null:G__35473.constructor);
if((G__35473__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__35473__$1);
}
}
})();
