...
if((i < len)){
var k = (ks[i]);
var G__36171 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__36172 = (i + (1));
m = G__36171;
i = G__36172;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__36173 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__36173) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__36173));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36175 = c;
var G__36175__$1 = (((G__36175 == null))?null:G__36175.prototype);
if((G__36175__$1 == null)){
return null;
} else {
return (G__36175__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36177 = c;
var G__36177__$1 = (((G__36177 == null))?null:G__36177.prototype);
if((G__36177__$1 == null)){
return null;
} else {
return (G__36177__$1["render"]);
}
})() == null)))));
});
...
var G__36179 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36179) : reagent.impl.component.as_element.call(null,G__36179));
};
...
G__36181.cljs$lang$applyTo = (function (arglist__36183){
var args = cljs.core.seq(arglist__36183);
...
var _STAR_current_component_STAR__orig_val__36185 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36186 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36186;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36185;
}});
...
return ((function (G__36187,G__36187__$1){
...
var c = this;
var G__36192_36194 = (c["cljsRatom"]);
if((G__36192_36194 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36192_36194);
}
...
var renders_36196 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_36197 = cljs.core.first(cljs.core.vals(renders_36196));
if((cljs.core.count(renders_36196) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36196))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36197)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36197], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__36195 = name;
switch (G__36195) {
case "":
...
var G__36200 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__36200) : reagent.impl.component.global$module$create_react_class.call(null,G__36200));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__36201 = fiber;
var G__36201__$1 = (((G__36201 == null))?null:(G__36201["type"]));
if((G__36201__$1 == null)){
return null;
} else {
return (G__36201__$1["displayName"]);
}
})();
var parent = (function (){var G__36202 = fiber;
if((G__36202 == null)){
return null;
} else {
return (G__36202["return"]);
}
})();
var path = (function (){var G__36203 = parent;
var G__36203__$1 = (((G__36203 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__36203) : reagent.impl.component.fiber_component_path.call(null,G__36203)));
if((G__36203__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36203__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__36205 = c;
if((G__36205 == null)){
return null;
} else {
return (G__36205["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__36206._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__36208 = c;
if((G__36208 == null)){
return null;
} else {
return (G__36208["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__36210 = c;
if((G__36210 == null)){
return null;
} else {
return G__36210._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__36212 = instance;
if((G__36212 == null)){
return null;
} else {
return (G__36212["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__36213 = instance;
if((G__36213 == null)){
return null;
} else {
return G__36213._currentElement;
}
}
})();
var name = (function (){var G__36214 = elem;
var G__36214__$1 = (((G__36214 == null))?null:(G__36214["type"]));
if((G__36214__$1 == null)){
return null;
} else {
return (G__36214__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__36216 = elem;
if((G__36216 == null)){
return null;
} else {
return (G__36216["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__36217._owner;
}
}
})();
var path = (function (){var G__36218 = owner;
var G__36218__$1 = (((G__36218 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__36218) : reagent.impl.component.component_path.call(null,G__36218)));
if((G__36218__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36218__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__36219 = c;
var G__36219__$1 = (((G__36219 == null))?null:G__36219.constructor);
if((G__36219__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__36219__$1);
}
}
})();
