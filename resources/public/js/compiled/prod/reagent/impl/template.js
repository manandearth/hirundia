...
var G__35493 = o;
(G__35493[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__35497 = o;
(G__35497[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__35499__i < G__35499__a.length) {G__35499__a[G__35499__i] = arguments[G__35499__i + 0]; ++G__35499__i;}
  args = new cljs.core.IndexedSeq(G__35499__a,0,null);
} 
return G__35498__delegate.call(this,args);};
G__35498.cljs$lang$maxFixedArity = 0;
G__35498.cljs$lang$applyTo = (function (arglist__35500){
var args = cljs.core.seq(arglist__35500);
...
var G__35502 = props;
var G__35502__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35502,cljs.core.cst$kw$id,id):G__35502);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35502__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__35503){
...
var props = map__35504__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35504__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__35504,map__35504__$1,props,class$){
return (function (c){
...
});})(map__35504,map__35504__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__35506){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35507__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__35507,map__35507__$1,on_write){
return (function (){
...
});})(node_value,map__35507,map__35507__$1,on_write))
);
} else {
...
var G__35510 = jsprops;
(G__35510["defaultValue"] = value);

(G__35510["onChange"] = ((function (G__35510,v,value,on_change){
return (function (p1__35509_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__35509_SHARP_);
});})(G__35510,v,value,on_change))
);
...
var vec__35513 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35513,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35513,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35513,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___35517 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___35517 == null)){
} else {
var key_35518 = temp__5724__auto___35517;
(jsprops["key"] = key_35518);
}
...
var temp__5724__auto___35519 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___35519 == null)){
} else {
var key_35520 = temp__5724__auto___35519;
reagent.impl.template.oset(jsprops,"key",key_35520);
}
...
var G__35521 = reagent.impl.template.__GT_NativeWrapper();
(G__35521["name"] = c);
...
var G__35522 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__35522) : reagent.impl.template.as_element.call(null,G__35522));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35526){
var G__35527 = cljs.core.first(seq35526);
var seq35526__$1 = cljs.core.next(seq35526);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35527,seq35526__$1);
});
...
break;
default:
var G__35533 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__35533;
continue;
...
var n__4607__auto___35535 = a.length;
var i_35536 = (0);
while(true){
if((i_35536 < n__4607__auto___35535)){
(a[i_35536] = reagent.impl.template.as_element((a[i_35536])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___35538 = a.length;
var i_35539 = (0);
while(true){
if((i_35539 < n__4607__auto___35538)){
var val_35540 = (a[i_35539]);
if(((cljs.core.vector_QMARK_(val_35540)) && ((reagent.impl.template.key_from_vec(val_35540) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_35539] = reagent.impl.template.as_element(val_35540));

var G__35541 = (i_35539 + (1));
i_35539 = G__35541;
continue;
} else {
}
...
var ctx = ({});
var vec__35542 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35542,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35542,(1),null);
...
var G__35545 = (cljs.core.count(argv) - first_child);
switch (G__35545) {
case (0):
...
case (1):
var G__35546 = comp;
var G__35547 = jsprops;
var G__35548 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__35546,G__35547,G__35548) : reagent.impl.template.global$module$react.createElement.call(null,G__35546,G__35547,G__35548));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__35545){
